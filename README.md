...
![Release](https://img.shields.io/badge/Release-v0.2.5-blue)
...
1. 到 [Releases](../../releases) 下载 `naixi-desktop_0.2.5_x64-setup.exe`
...
**当前 0.2.5 安装包尚未做代码签名**（未购置 OV/EV 证书）。因此 Windows SmartScreen 会提示「未知发布者」，这是预期行为、不是被篡改——**正因如此，上面两步哈希校验更要照做**。补签名后本段会更新。
