      ...
      {sideTab && (
        <div className="flex border-l border-sakura-100 bg-white">
          ...
          <div className="w-80 min-w-[20rem] flex flex-col">
            {sideTab === "detail" && activeKey && <DetailPanel activeKey={activeKey} messageCount={msgs.length} tokenEstimate={realTokens ? (realTokens.input! + realTokens.output!) : 0} modelKey={modelKey} />}
            {sideTab === "resource" && (
